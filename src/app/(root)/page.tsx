        ...
        >
          ...
          <div className="relative z-20 lg:w-1/2 lg:pl-12 text-center lg:text-left px-4 md:px-8 lg:px-12 lg:pl-24">
            ...
            >
              ...
              <br />
              Perfect for collecting feedback, conducting research, or
              organizing events.
            </motion.p>
            <motion.div
          ...
          <div className="container mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Experience a clean and simple interface that lets you create
                  and manage surveys with ease.
                </p>
              </motion.div>
              <motion.div
                className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300"
              ...
              >
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Choose from a variety of templates and customize them to
